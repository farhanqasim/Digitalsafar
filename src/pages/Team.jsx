        ...
        <div className="container">
          <div className="row">
            <div className="page-heading">
              ...
              <h2 className="wow fadeInUp" data-wow-delay=".3s">Our Team</h2>
            </div>
          </div>
        </div>
      </section>
      <section className="section-padding fix">
        <div className="container">
          <div className="section-title text-center">
            <span className="wow fadeInUp">Team</span>
            <h2 className="char-animation">Meet Digital Safar</h2>
          </div>
          <p className="text-center mt-3">Our team delivers web, mobile, design, and marketing solutions.</p>
